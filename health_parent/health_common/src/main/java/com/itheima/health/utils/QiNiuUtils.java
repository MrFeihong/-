...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "gQynLH3OTwommp46ebiPpX4Cgh9viGcnPAep-v6u";
    private static final String SECRETKEY = "WsFqi2vgaJI7aJOCm99j_iIlfNvWRfcQXs70BWcU";
    private static final String BUCKET = "materialpicturem";
    public static final String DOMAIN = "http://qmm1rilgj.hn-bkt.clouddn.com/";
