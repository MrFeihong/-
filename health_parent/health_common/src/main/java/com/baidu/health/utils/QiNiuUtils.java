...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "FYqj3k6BPxKLhTCF5HZTljk5WKekg6OFxZ8Su8sq";
    private static final String SECRETKEY = "_e0g_ejv5Awdb_fhsMFQGip2aICWl5DhexQK38tW";
    private static final String BUCKET = "health-parent-puls";
    public static final String DOMAIN = "http://qmlwq43nl.hn-bkt.clouddn.com/";
    private static long logTimestemp4Toke = 0l;
    private static String token = null;

    public static void main(String[] args) {
        uploadFile("C:\\Users\\钟宝晋\\Desktop\\QQ图片20201026094116.jpg","dd2.jpg");
